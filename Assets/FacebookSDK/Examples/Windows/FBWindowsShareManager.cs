...
public class FBWindowsShareManager : MonoBehaviour
{
    ...
    {
        var imagePath = Path.GetFullPath(Application.streamingAssetsPath + "/" + ImageFile.text);
    ...
    {
        var videoPath = Path.GetFullPath(Application.streamingAssetsPath + "/" + VideoFile.text);
